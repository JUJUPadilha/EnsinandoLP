...
function init() {
  ...
  document.title = "viajando para a terra"
...
// Executa a animação dos pontos a cada 500ms
setInterval(animateDots, 500);

// Redireciona para outro site após 10 segundos
setTimeout(() => {
  window.location.href = "../PaginasHTML/LP.html"; // Substitua pelo URL desejado
}, 3000); // 10 segundos